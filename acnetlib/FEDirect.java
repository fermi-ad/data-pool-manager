// $Id: FEDirect.java,v 1.3 2023/12/13 21:40:33 kingc Exp $
...
public class FEDirect extends Thread implements AcnetReplyHandler, DPMProtocolReplier
{
	...
	final AcnetConnection connection = AcnetConnection.open();
	...
	public static void main(String[] args)
	{
		try {
			...
			final WhatDaq whatDaq = new WhatDaq(0, new DPMRequest(args[1]));
