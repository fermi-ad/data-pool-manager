// $Id: Node.java,v 1.3 2023/12/13 17:04:49 kingc Exp $
...
public class Node implements NodeFlags, AcnetErrors
{
	...
	public synchronized static Node get(int value) throws AcnetStatusException
	{
		...
		System.out.printf("cant find node 0x%04x\n", value);
	...
	final public SocketAddress address()
	{
		return address;
	}
	...
	final static void cacheNodes() throws AcnetStatusException
	{
